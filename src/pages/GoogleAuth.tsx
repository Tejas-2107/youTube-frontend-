const GoogleAuth = () => {
  const handleGoogleAuth = async () => {
    ...
    const redirect_uri="https://youtube-frontend-wine.vercel.app/callbackGoogle";
  ...
  return (
    <div className='fixed inset-0 flex items-center justify-center'>
      <button onClick={handleGoogleAuth} type="button" className="text-white bg-[#4285F4] hover:bg-[#4285F4]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 me-2 mb-2">
